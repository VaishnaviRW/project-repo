...
thresh = 0.27
modelPath = "D:/be/shape_predictor_68_face_landmarks.dat"
sound_path = "C:/Users/Hp/Downloads/ME/camear/alarm.wav"
...
def soundAlert(path, threadStatusQ):
    while True:
        if not threadStatusQ.empty():
            ...
            if FINISHED:
                break
        playsound.playsound("C:/Users/Hp/Downloads/ME/camear/alarm.wav")
